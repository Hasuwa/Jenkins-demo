...
public class AddToCartTest4 extends AddToCartTestBase{
	final int TEST_NUM = 7;
	
	@BeforeTest(groups = "checkG")
	public void beforeCheck() {
		beforeCheckItem(TEST_NUM);
	}

	@AfterMethod(groups = "checkG")
	 ...
	 */
	@Test(groups = "checkG")
	public void checkItemG() {
		//無効なXpathを指定してfailさせる
		final int CATEGORY_NUM = 0;
