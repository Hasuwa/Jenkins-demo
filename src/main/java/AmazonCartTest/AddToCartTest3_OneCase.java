...
public class AddToCartTest3_OneCase {
	WebDriver driver;
	WebElement itemB;
	String itemBName;
	...
	public void itemBClick() {
		...
		itemB.click();
		System.out.println("カートに追加した商品：" + itemBName);
	}
	...
	public void checkItemB() {
		...
		System.out.println("カート内の商品：" + goodBInBasket);
