...
public class AddToCartTest1 {
	...
	final String CATEGORY2_XPATH = "/html/body/div[1]/div[2]/div[2]/div/div/div/div[2]/div/div[2]/div/div/div[2]/div[17]/a";
	...
	public void maximizeWindow() {
		...
		System.out.println("site opened1");
	}

	/**
	 * ランキングページに遷移し、ジャンル1を指定
	 */
	public void rankingClick1() {
		...
		System.out.println("ランキング画面1");
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(CATEGORY1_XPATH)));
		this.driver.findElement(By.xpath(CATEGORY1_XPATH)).click();
		System.out.println("カテゴリー選択1");
	}
	...
	public void itemAClick() {
		...
		itemA.click();
		System.out.println("カートに追加した商品1：" + itemAName);
	}
	...
	public void itemBClick() {
		...
		itemB.click();
		System.out.println("カートに追加した商品1：" + itemBName);
	}
	...
	public void checkItemA() {
		...
		System.out.println("カート内の商品1：" + goodAInBasket);
		boolean result = goodAInBasket.regionMatches(1, itemAName, 1, 8);
		// Check cart item
